...
type ModuleHandler<P extends string = string, I extends Input = {}> = Handler<
	EvlogVariables,
	P,
	I
>;
...
type ModuleRouteRegistrar = {
	...
	>(
		path: P,
		...handlers: [
			ModuleMiddleware<P, I, E2>,
			ModuleMiddleware<P, I2, E3>,
			ModuleHandler<P, I3>,
		]
	): Effect.Effect<void>;
	(
		path: string,
		...handlers: Array<ModuleMiddleware | ModuleHandler>
	): Effect.Effect<void>;
};
