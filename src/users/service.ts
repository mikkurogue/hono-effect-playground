...
export function getUsers() {
  return Effect.gen(function* () {
    ...
    if (!parsedUsers.success) {
      return yield* Effect.fail(new UserValidationError({ message: parsedUsers.error.message }));
    }
...
export function createUser(user: CreateUserInput) {
  return Effect.gen(function* () {
    ...
    if (!parsedUser.success) {
      return yield* Effect.fail(new UserValidationError({ message: parsedUser.error.message }));
    }
